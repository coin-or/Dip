...
1. Fixed long-standing issues with stand-alone apps

2. Small some bug fixes 

Release 0.9.11:

1. Added some new DipPy examples

2. Small bug fixes 

Release 0.9.10:

1. Fixes to stand-alone app examples

2. Fixes to Visual studio files for examples to support property pages 

New Stable Version 0.91:

1. Changes to the DipPy callback interface to make it more user friendly

2. Changes to the application interface

3. Planning for other changes to the internal algorithm 

Release 0.9.9:

1. Fixes to DipPy build and examples

2. Fixes to allow CGL cuts to be generated from within DipPy branch and price. 

Release 0.9.8:

1. Fixes to DipPy examples

2. Support for dependency linking 
...
1. Fixes to allow proper installation of DipPy on Mac OS X 

Release 0.9.5:

1. Small fixes to DipPy

Release 0.9.4:

1. Fixes to parallel subproblem solution mode with OpenMP

Release 0.9.3:

1. More updates to build system

Release 0.9.2:

1. Updates to build system

Release 0.9.1:

1. Fixes to Python installation
