...
void AlpsDecompModel::setAlpsSettings() {
  ...
  UtilPrintFuncBegin(&cout, m_classTag, "setAlpsSettings()", m_param.msgLevel,
                     3);
  ...
  UtilPrintFuncEnd(&cout, m_classTag, "setAlpsSettings()", m_param.msgLevel, 3);
}
...
AlpsTreeNode *AlpsDecompModel::createRoot() {
  ...
  //---
  UtilPrintFuncBegin(&cout, m_classTag, "createRoot()", m_param.msgLevel, 3);
  ...
  AlpsDecompNodeDesc *desc = new AlpsDecompNodeDesc(
      this, modelCore.getModel()->getColLB(), modelCore.getModel()->getColUB());
  assert(desc);
  root->setDesc(desc);
  // root->setExplicit(1);
  UtilPrintFuncEnd(&cout, m_classTag, "setAlpsSettings()", m_param.msgLevel, 3);
...
AlpsExitStatus AlpsDecompModel::solve() {
  ...
  globalTimer.reset();
#endif
  UtilPrintFuncBegin(&cout, m_classTag, "solve()", m_param.msgLevel, 3);
  //---
  ...
  UtilPrintFuncEnd(&cout, m_classTag, "solve()", m_param.msgLevel, 3);
