...
//===========================================================================
int KnapsackSortRatio(const int n, const double *p, const double *w,
                      double *psort, double *wsort) {
  //---
...
//===========================================================================
void KnapsackSortRatioOut(const int n, const double *p, const double *w,
                          double *psort, double *wsort, SOR_IntDbl *ratio) {
  //---
  //--- Sort non-increasing order of p[j]/w[j]. Return the new
  //--- order in psort, wsort which will be of size n+1 to conform
  //--- to the routine SOR_KnapsackOptimizeHS.
...
//===========================================================================
int KnapsackOptimizeHS(const int n, const double c, double *p, double *w,
                       int *x, double *z, int *pstatus) {
  //---
             ...
             for (k = 0; k < n; k++) {
               if (x[k] == 1) {
                 ...
                 printf("\n"
                        ...
                        k, x[k], w[k], p[k]);
                 printf("wSum: %12.4f, pSum: %12.4f", wSum, pSum);
               }
             });
  UTIL_DELPTR(xhat);
  return KP_OPTIMAL;
