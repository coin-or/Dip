...
void SmallIP_DecompApp::createModels() {
  ...
  m_modelPart1.M = new CoinPackedMatrix(isRowOrdered, rowIndices1, colIndices1,
                                        elements1, numNzs1);
  m_modelPart2.M = new CoinPackedMatrix(isRowOrdered, rowIndices2, colIndices2,
                                        elements2, numNzs2);
...
#endif
  m_osi.loadProblem(*m_modelPart1.getMatrix(), m_modelPart1.getColLB(),
                    m_modelPart1.getColUB(), NULL, m_modelPart1.getRowLB(),
                    m_modelPart1.getRowUB());
  m_osi.setInteger(m_modelPart1.getIntegerVars(), m_modelPart1.getNumInts());
...
//===========================================================================//
DecompSolverStatus SmallIP_DecompApp::solveRelaxed(const int whichBlock,
  ...
  DecompVar *var =
      new DecompVar(nOrigCols, colSolution, varRedCost, varOrigCost);
