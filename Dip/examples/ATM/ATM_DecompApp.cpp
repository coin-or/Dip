...
void ATM_DecompApp::initializeApp() {
  ...
  m_instance.readInstance(fileNameA, fileNameD, fileNameAD);
...
void ATM_DecompApp::addColumnNamesA(DecompConstraintSet *model,
                                    const string prefix, const int offset) {
  ...
  colIndex = offset;
  for (a = 0; a < nAtms; a++) {
    colName = prefix + "(" + UtilIntToStr(colIndex) + "_" +
...
void ATM_DecompApp::addColumnNamesAT(DecompConstraintSet *model,
  ...
  for (a = 0; a < nAtms; a++) {
    if (m_appParam.UseTightModel) {
      for (t = 0; t <= nSteps; t++) {
        colName = prefix + "(" + UtilIntToStr(colIndex) + "_" +
                  m_instance.getAtmName(a) + "," + UtilIntToStr(t) + ")";
        model->colNames.push_back(colName);
        colIndex++;
      }
    } else {
      for (t = 0; t < nSteps; t++) {
        colName = prefix + "(" + UtilIntToStr(colIndex) + "_" +
                  m_instance.getAtmName(a) + "," + UtilIntToStr(t + 1) + ")";
        model->colNames.push_back(colName);
        colIndex++;
      }
    }
...
void ATM_DecompApp::addColumnNamesAD(DecompConstraintSet *model,
  ...
  for (vi = pairsAD.begin(); vi != pairsAD.end(); vi++) {
    ...
    d = adP.second;
    colName = prefix + "(" + UtilIntToStr(colIndex) + "_" +
              m_instance.getAtmName(a) + "," + m_instance.getDateName(d) + ")";
    model->colNames.push_back(colName);
    colIndex++;
  }
}
...
int ATM_DecompApp::createConZtoX(DecompConstraintSet *model,
  ...
  if (m_appParam.UseTightModel) {
    for (t = 0; t <= nSteps; t++) {
      ...
      string strAT = "(a_" + m_instance.getAtmName(atmIndex) + ",t_" +
                     UtilIntToStr(t) + ")";
    ...
    string rowName2 = "ztox2(a_" + m_instance.getAtmName(atmIndex) + ")";
...
DecompConstraintSet *ATM_DecompApp::createModelCore1(bool includeCount) {
  ...
  UtilPrintFuncBegin(m_osLog, m_classTag, "createModelCore1()",
                     m_appParam.LogLevel, 2);
  ...
  for (d = 0; d < nDates; d++) {
    string rowName = "budget(d_" + m_instance.getDateName(d) + ")";
  ...
  UtilPrintFuncEnd(m_osLog, m_classTag, "createModelCore1()",
                   m_appParam.LogLevel, 2);
...
DecompConstraintSet *ATM_DecompApp::createModelCore2() {
  ...
  UtilPrintFuncBegin(m_osLog, m_classTag, "createModelCore2()",
                     m_appParam.LogLevel, 2);
  ...
  UtilPrintFuncEnd(m_osLog, m_classTag, "createModelCore2()",
                   m_appParam.LogLevel, 2);
...
DecompConstraintSet *ATM_DecompApp::createModelCoreCount() {
  ...
  UtilPrintFuncBegin(m_osLog, m_classTag, "createModelCoreCount()",
                     m_appParam.LogLevel, 2);
  ...
  UtilPrintFuncEnd(m_osLog, m_classTag, "createModelCoreCount()",
                   m_appParam.LogLevel, 2);
...
DecompConstraintSet *ATM_DecompApp::createModelRelax1(const int a,
  ...
  UtilPrintFuncBegin(m_osLog, m_classTag, "createModelRelax1()",
                     m_appParam.LogLevel, 2);
  ...
  for (vi = pairsAD.begin(); vi != pairsAD.end(); vi++) {
    ...
    CoinPackedVector row;
    string rowName = "demand_def(a_" + m_instance.getAtmName(a) + ",d_" +
    ...
    string rowNameLink = "linkv(a_" + m_instance.getAtmName(a) + ",d_" +
                         m_instance.getDateName(d) + ")";
  ...
  UtilPrintFuncEnd(m_osLog, m_classTag, "createModelRelax1()",
                   m_appParam.LogLevel, 2);
...
DecompConstraintSet *ATM_DecompApp::createModelRelax2(const int d) {
  ...
  UtilPrintFuncBegin(m_osLog, m_classTag, "createModelRelax2()",
                     m_appParam.LogLevel, 2);
  ...
  UtilPrintFuncEnd(m_osLog, m_classTag, "createModelRelax2()",
                   m_appParam.LogLevel, 2);
...
DecompConstraintSet *ATM_DecompApp::createModelRelaxCount() {
  ...
  UtilPrintFuncBegin(m_osLog, m_classTag, "createModelRelaxCount()",
                     m_appParam.LogLevel, 2);
  ...
  UtilPrintFuncEnd(m_osLog, m_classTag, "createModelRelaxCount()",
                   m_appParam.LogLevel, 2);
...
void ATM_DecompApp::createModels() {
  ...
  UtilPrintFuncEnd(m_osLog, m_classTag, "APPcreateModel()", m_appParam.LogLevel,
                   2);
}

//===========================================================================//
bool ATM_DecompApp::APPisUserFeasible(const double *x, const int nCols,
  ...
  UtilPrintFuncBegin(m_osLog, m_classTag, "APPisUserFeasible()",
                     m_appParam.LogLevel, 2);
  ...
  for (vi = pairsAD.begin(); vi != pairsAD.end(); vi++) {
    ...
    rhs = e_ad[*vi] + b_ad[*vi] * x[colIndex_x2(a)] +
  ...
  for (vi = pairsAD.begin(); vi != pairsAD.end(); vi++) {
    ...
    if (lhs < -0.01) {
      if (fabs(x[getColOffset_v() + pairIndex] - 1.0) > tolZero) {
        printf(
            "NOT FEASIBLE fp=%10.5f fm=%10.5f f=%10.5f < 0, but v=%g not 1\n",
  ...
  UtilPrintFuncEnd(m_osLog, m_classTag, "APPisUserFeasible()",
                   m_appParam.LogLevel, 2);
