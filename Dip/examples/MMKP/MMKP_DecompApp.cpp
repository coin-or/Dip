...
void MMKP_DecompApp::initializeApp() {
  ...
  if (dataFormat == "khan" || dataFormat == "hifi")
    ...
    throw UtilException("Unknown data format", "initializeApp",
                        "MMKP_DecompApp");
...
void MMKP_DecompApp::createModelPartMDKP(DecompConstraintSet *model,
  ...
  UtilPrintFuncBegin(m_osLog, m_classTag, "createModelPartMDKP()",
                     m_appParam.LogLevel, 2);
  ...
  UtilPrintFuncEnd(m_osLog, m_classTag, "createModelPartMDKP()",
                   m_appParam.LogLevel, 2);
}
...
void MMKP_DecompApp::createModelPartMCKP(DecompConstraintSet *model,
  ...
  //---  sum{j in 1..l[i]}                      x[i,j]  = 1   , i in 1..n
  //---
  UtilPrintFuncBegin(m_osLog, m_classTag, "createModelPartMCKP()",
                     m_appParam.LogLevel, 2);
  ...
  UtilPrintFuncEnd(m_osLog, m_classTag, "createModelPartMCKP()",
                   m_appParam.LogLevel, 2);
}

//===========================================================================//
DecompSolverStatus MMKP_DecompApp::solveRelaxed(const int whichBlock,
  ...
  if (m_appParam.ModelNameRelax == "MCKP0") {
    ...
    mcknapK->solveMCKnap(redCostX, m_objective, solInd, solEls, varRedCost,
                         varOrigCost);
    ...
    DecompVar *var =
        new DecompVar(solInd, solEls, varRedCost - convexDual, varOrigCost);
...
//===========================================================================//
void MMKP_DecompApp::printOriginalColumn(const int index, ostream *os) const {
