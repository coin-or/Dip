...
//===========================================================================//
void MMKP_Instance::readInstance(string &fileName, string &dataFormat) {
  ...
  if (status)
    throw UtilException("Failed to read instance", "readInstance",
                        "MMKP_Instance");
  is >> m_nGroupRows >> m_nGroupCols >> m_nKnapRows;
...
//===========================================================================//
void MMKP_Instance::readBestKnown(string &fileName, string &instanceName) {
  ...
  if (status)
    throw UtilException("Failed to best-known file", "readBestKnown",
                        "MMKP_Instance");
  while (!is.eof()) {
