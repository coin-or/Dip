...
\lstinputlisting[linerange=1-3]{C:/COIN/Dippy/examples/tsp.py}
...
\lstinputlisting[firstnumber=7,linerange=7-17]{C:/COIN/Dippy/examples/tsp.py}

\item Define the Euclidean distance using {\tt sqrt};
\lstinputlisting[firstnumber=19,linerange=19-21]{C:/COIN/Dippy/examples/tsp.py}

\item Define the arcs between cities, the arcs in/out of a city and the cost of the arcs as the distance between cities;
\lstinputlisting[firstnumber=21,linerange=23-31]{C:/COIN/Dippy/examples/tsp.py}
...
\end{align*}
\lstinputlisting[firstnumber=33,linerange=33-38]{C:/COIN/Dippy/examples/tsp.py}
\lstinputlisting[firstnumber=40,linerange=40-42]{C:/COIN/Dippy/examples/tsp.py}

\item  Solve the \ac{TSP} using \ac{DIP} and display the minimum cost tour;
\lstinputlisting[firstnumber=118,linerange=118-124]{C:/COIN/Dippy/examples/tsp.py}
