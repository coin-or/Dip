...
\lstinputlisting[linerange=1-2]{C:/COIN/Dippy/examples/cutting_stock.py}
...
\lstinputlisting[firstnumber=4,linerange=4-8]{C:/COIN/Dippy/examples/cutting_stock.py}
\lstinputlisting[firstnumber=10,linerange=10-22]{C:/COIN/Dippy/examples/cutting_stock.py}
...
\lstinputlisting[firstnumber=24,linerange=24-29]{C:/COIN/Dippy/examples/cutting_stock.py}

\item Define a two dimensional set of items cut from patterns (cf. \ref{itm:2d} from \sbsref{sbs:coke});
\lstinputlisting[firstnumber=31,linerange=31-32]{C:/COIN/Dippy/examples/cutting_stock.py}
...
\lstinputlisting[firstnumber=34,linerange=34-40]{C:/COIN/Dippy/examples/cutting_stock.py}
...
\lstinputlisting[firstnumber=42,linerange=42-43]{C:/COIN/Dippy/examples/cutting_stock.py}

\item We want to meet demand for sponge rolls;
\lstinputlisting[firstnumber=45,linerange=45-48]{C:/COIN/Dippy/examples/cutting_stock.py}
...
\lstinputlisting[firstnumber=50,linerange=50-53]{C:/COIN/Dippy/examples/cutting_stock.py}
...
\lstinputlisting[firstnumber=186,linerange=186-198]{C:/COIN/Dippy/examples/cutting_stock.py}
