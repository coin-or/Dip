...
\lstinputlisting[firstnumber=5,linerange=5-6]{C:/COIN/Dippy/examples/coke.py}
...
\lstinputlisting[firstnumber=11,linerange=11-22]{C:/COIN/Dippy/examples/coke.py}
\newpage
\lstinputlisting[firstnumber=24,linerange=24-45]{C:/COIN/Dippy/examples/coke.py}
...
\lstinputlisting[firstnumber=47,linerange=47-65]{C:/COIN/Dippy/examples/coke.py}

\item Read the data from the tables;
\lstinputlisting[firstnumber=79,linerange=79-81]{C:/COIN/Dippy/examples/coke.py}

\item Define the arcs and their costs from the mine $\rightarrow$ plant and plant $\rightarrow$ customer costs;
\lstinputlisting[firstnumber=83,linerange=83-86]{C:/COIN/Dippy/examples/coke.py}

\item \label{itm:2d} Define a 2-dimensional set for the plant sizes at each location;
\lstinputlisting[firstnumber=88,linerange=88-89]{C:/COIN/Dippy/examples/coke.py}
...
\lstinputlisting[firstnumber=91,linerange=91-99]{C:/COIN/Dippy/examples/coke.py}

\item Add the objective of minimising total cost = building costs (converted from MRMB to RMB) + transportation costs;
\lstinputlisting[firstnumber=101,linerange=101-106]{C:/COIN/Dippy/examples/coke.py}

\item Add constraints that limit the flow of coke out of a coke-making plant depending on the capacity plant constructed;
\lstinputlisting[firstnumber=108,linerange=108-113]{C:/COIN/Dippy/examples/coke.py}
...
\lstinputlisting[firstnumber=115,linerange=115-118]{C:/COIN/Dippy/examples/coke.py}
...
\lstinputlisting[firstnumber=120,linerange=120-133]{C:/COIN/Dippy/examples/coke.py}

\item Solve the \ac{MILP} problem using \ac{DIP} and display the solution in tabular form;
\lstinputlisting[firstnumber=160,linerange=160-178]{C:/COIN/Dippy/examples/coke.py}
\end{enumerate}
